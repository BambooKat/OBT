const en = {
  ...
  dashboard: {
    ...
    containerHint: 'A project groups several lines (e.g. "Lupus No Basket" containing Kuroko, Aomine...). It has no colours of its own.',
    containerName: 'Project name',
    containerNamePlaceholder: 'e.g. Lupus No Basket',
